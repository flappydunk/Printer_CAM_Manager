...
<div id="Commands" class="tabcontent">
    <table style="width:100%" >
        <tr>
            ...
            <button type="button" class="button blue" class="button" onclick="Send('vflip');">V_Flip</button>
            <button type="button" class="button blue" class="button" onclick="Send('hmirr');">H_Mirror</button>
		</td> 
        </tr>  
	<tr>
        	<td>
...
// Get the 2D rendering context of the canvas
   ...
   function Send(x) {
     ...
     if (x == 'vflip'){  xhr.open("GET", "/action?go=" + x, true);};
     if (x == 'hmirr'){  xhr.open("GET", "/action?go=" + x, true);};
